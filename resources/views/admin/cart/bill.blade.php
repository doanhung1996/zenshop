...
<head>
    ...
    <style type="text/css">
        ...
        #customer td, #customers th,#customers tr {
            text-align: center !important;
            border: 1px solid #ddd !important;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableContent bgBody" align="center"  style='font-family:helvetica, sans-serif;'>
    ...
    <tbody>
    <tr>
        <td height='25' class="m_610716475632561540" colspan='3'></td>
    </tr>
    <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td valign="top" class="spechide"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                            <tr>
                                <td height='130' class="m_610716475632561540">&nbsp;</td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
                    ...
                    <td valign="top" width="600"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="MainContainer" bgcolor="#ffffff">
                            ...
                            <tr>
                                <td class='movableContentContainer'>
                                    ...
                                    <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top'>
                                            <tr><td height='25' bgcolor='white'></td></tr>
                                            <!-- <tr><td height='1' bgcolor='#DA5454'></td></tr> -->
                                                            ...
                                                            <td  align='center' width='530'>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class="contentEditable" style='font-size:32px;color:#555555;font-weight:normal;'>
                                                                       {{--<h2 style='font-size:17px;'> <a style="text-decoration: none; color:#27bdb1" href="http://zenzen.com.vn/">ZENZEN Vietnam™ .</a></h2>--}}
                                                                        <h2 style='font-size:17px;'>HÓA ĐƠN THANH TOÁN</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td  width='70'></td>
                                    ...
                                    <h2 style="color: #27bdb1; font-size: 17px; margin-left: 18px;">Thông Tin Đơn Hàng<p style="display: inline; font-size: 13px; text-align: center; line-height: 1.4; color: #8c8c8c;"> (Thời gian: {{$order->order_date}})</p></h2>
                                                ...
                                                <tr><td height='20'>
                                                        <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                                                <h2 style="margin-left: 18px; font-size: 15px; display: inline; color: #555555;">Khoảng thời gian nhận hàng  : </h2><p style="display: inline;"> {{$order->date_transport}}</p>
                                                            </div>
                                                            <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                                                ...
                                                                <table width="251" border="0" cellspacing="0" cellpadding="0" align="center" valign='top'>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class='contentEditableContainer contentTextEditable'>
                                                                                <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                                                                    <p >Địa Chỉ :{{$order->address}},{{$order->city}},{{$order->province}}, Việt Nam </p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                    ...
                                    <div>
                                        <h2 style="color: #27bdb1; font-size: 17px; margin-left: 18px;">Chi Tiết Đơn Hàng<p style="display: inline; font-size: 13px; text-align: center; line-height: 1.4; color: #8c8c8c;"> ( Mã đơn hàng: {{$order->order_code}}  )</p></h2>
                                        {{--<hr style="background: red">--}}
                                        <table id="customer" style="width:100%;" class="table table-small-font" style="margin-bottom: 0">
                                            <thead>
                                            <tr height='20'></tr>
                                            <tr class='tr'>
                                                <th class='th' style=" font-weight:normal">Sản Phẩm</th>
                                                <th class='th' style=" font-weight:normal">Số Lượng</th>
                                                <th class='th' style=" font-weight:normal">Giá</th>
                                                <th class='th' style=" font-weight:normal">Tổng</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            @foreach($order->order_detail as $order_detail)
                                                <tr class='tr'>
                                                    ...
                                                    <td>@php echo number_format($order_detail->price,0).'đ'@endphp</td>
                                                    <td>@php echo number_format($order_detail->subtotal,0).'đ'@endphp</td>
                                                </tr>
                                            @endforeach
                                                @endif()
                                            </tbody>
                                        ...
                                        <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top'>
                                                ...
                                                <tr><td height='20'>
                                                        <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='text-align: left; color:#999999;font-size:13px;line-height:19px;'>
                                                                <h2 style="margin-left: 18px; font-size: 15px; display: inline; color: #555555;">Tổng Số Lượng: </h2><p style="display: inline;">{{$order->total_qty}}</p>
                                                            </div>
                                                            <div class='contentEditable' style='text-align: left; color:#999999;font-size:13px;line-height:19px;'>
                                                                <h2 style="margin-left: 18px; font-size: 15px; display: inline; color: #555555;">Tổng Cộng: </h2><p style="display: inline;">@php echo number_format($order->total_sale,0).'đ'@endphp</p>
                                                            </div>
                                                        </div>
                                                    </td></tr>
                                            </table>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top' >
                                                        <tr>
                                                            <td align='left' valign='top'>
                                                                <div class="contentEditableContainer contentTextEditable" >
                                                                    <div class="contentEditable" style='color:#555555;font-size:21px;font-weight:normal; text-align: center;'>
                                                                        <h2 class='big'>Cám ơn bạn đã sử dụng dịch vụ tại <a  style=" color:#27bdb1; text-decoration-color: white; text-decoration: none;" href="http://zenzen.com.vn">ZENZEN Vietnam™</a></h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align='left' valign='top'>
                                                                <div class="contentEditableContainer contentTextEditable" >
                                                                    <div class="contentEditable" style='color:#999999;font-size:13px;line-height:19px;'>
                                                                        {{--<p style="text-align: center;">Bạn cần hỗ trợ ngày Chỉ cần liên hệ email hungngu1996@gmail.com , hoặc gọi số điện thoại 0961265896.</p>--}}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                {{--<td valign='top' align='center'>--}}
                                                    {{--<div class="contentEditableContainer contentTextEditable">--}}
                                                        {{--<div class="contentEditable" style='color:#A8B0B6; font-size:13px;line-height: 16px;'>--}}
                                                            {{--<p >Email này được gửi từ hungngu1996@gmail.com khi bạn mua hàng tại Zenshop. Vui lòng thêm chúng tôi vào danh sách liên hệ của bạn để đảm bảo các bản tin nằm trong hộp thư đến của bạn.--}}
                                                            {{--</p>--}}
                                                        {{--</div>--}}
                                                    {{--</div>--}}
                                                {{--</td>--}}
