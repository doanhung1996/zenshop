...
<div id="main-content-wp" class="list-cat-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            <a href="{{route('post.cat.create')}}" title="" id="add-new" class="fl-left">Thêm mới</a>
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="">Tất cả <span class="count">{{$post_all}}</span> danh mục</a></li>
                        </ul>
                    </div>
                    <form method="POST" action="{{route('post.cat.status')}}" class="form-actions">
                        @csrf
                        <div class="actions">
                            <select name="actions">
                            ...
                            <tr>
                                ...
                                <td class="clearfix">
                                    ...
                                    <ul class="list-operation fl-right">
                                        <li><a href="{{route('post.cat.edit',$item->id)}}" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                    </ul>
                                </td>
                                <td><span class="tbody-text">{{$item->order}}</span></td>
