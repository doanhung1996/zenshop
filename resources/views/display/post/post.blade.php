                    ...
                    <div class="col-md-9">
                        ...
                        <div class="blog-post">
                            <article class="row">
                                ...
                                <div class="col-xs-5"> <span><i class="fa fa-bookmark-o"></i> @php echo date('d/m/Y - H:i:s',strtotime($item->created_at)); @endphp </span> <span><i class="fa fa-eye"></i>{{$item->viewer}} Views</span> <a href="{{route('post.display.show',[$check_category->slug,$check_parent->slug,$item->slug])}}" class="tittle">{{$item->title}} </a>
