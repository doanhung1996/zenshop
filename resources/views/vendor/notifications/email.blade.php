...
<head>
    ...
    <style type="text/css">
        ...
        #customer th {
            ...
            text-align: center !important;
            background-color:#27bdb1 !important;
                                                            ...
                                                            <td  align='center' width='530'>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class="contentEditable" style='font-size:32px;color:#555555;font-weight:normal;'>
                                                                        <h2 style='font-size:17px; text-align: center;'>Lấy Lại Mật Khẩu !</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td  width='70'></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td  align='center' width='530'>
                                                                <div class='contentEditableContainer contentTextEditable' style="text-align: left; ">
                                                                    <p style="font-size: 15px; text-align:center; margin-bottom:40px;">ZenZen Việt Nam vừa nhận được yêu cầu thay đổi mật khẩu đăng nhập vào website <a style="color: #27bdb1; text-decoration: none;" target="_blank" href="http://zenzen.com.vn">ZenZen.com.vn</a> cho tài khoản của bạn.</p>
                                                                    </p>
                                                                    <p style="font-size: 15px; text-align:center; margin-bottom:20px; margin-top:20px;"> Vui lòng bấm vào nút phía dưới !.</p>
                                                                    <div style="text-align:center; margin-top: 15px;"><a href="{{$actionUrl}}" style="min-width:200px;display:inline-block;background:#27bdb1;color:#ffffff;font-size:16px;text-transform:uppercase;text-align:center;padding:15px 30px;border-bottom:5px solid #27bdb1;font-family:Helvetica,Arial,sans-serif!important;text-decoration:none" target="_blank" data-saferedirecturl="zenshop">Lấy Lại Mật Khẩu</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td  width='70'></td>
                                        ...
                                        <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top'>
                                                <tr><td height='20'>
                                                        <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                                                {{--<h2 style="margin-left: 18px; font-size: 15px; display: inline; color: #555555;"> </h2><p style="display: inline;"> </p>--}}
                                                            </div>
                                                            <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                                                <!-- <h2 style="margin-left: 18px; font-size: 15px; display: inline; color: #555555;">Lưu ý: </h2><p style="display: inline;">Thời gian: 07-07-2018 10:22:46</p> -->
                                                            </div>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" valign='top' >
                                                            ...
                                                            <td align='left' valign='top'>
                                                                <div class="contentEditableContainer contentTextEditable" >
                                                                    <div class="contentEditable" style='color:#555555;font-size:21px;font-weight:normal; text-align: center;'>
                                                                        <h2 class='big' style="text-align: center; font-size: 14px;">Cám ơn bạn đã sử dụng dịch vụ tại <a  style=" color:#27bdb1; text-decoration-color: white; text-decoration: none;" href="http://zenzen.com.vn">Zenzen.com.vn</a> !</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align='left' valign='top'>
                                                                <div class="contentEditableContainer contentTextEditable" >
                                                                    <div class="contentEditable" style='color:#999999;font-size:13px;line-height:19px;'>
                                                                        <p style="text-align: center; font-size: 14px;">Bạn cần hỗ trợ ngày Chỉ cần liên hệ email hungngu1996@gmail.com , hoặc gọi số điện thoại 0961265896.</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td valign='top' align='center'>
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" style='color:#A8B0B6; font-size:13px;line-height: 16px;'>
                                                            <p style="font-size:13px;">Email này được gửi từ hungngu1996@gmail.com khi bạn mua hàng tại Zenshop. Vui lòng thêm chúng tôi vào danh sách liên hệ của bạn để đảm bảo các bản tin nằm trong hộp thư đến của bạn.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
