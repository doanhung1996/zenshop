                                                ...
                                                <tr><td height='20'>
                                                        <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='text-align: left; color:#999999;font-size:13px;line-height:19px;'>
                                                                <h2 style="margin-left: 18px; font-size: 15px; display: inline; color: #555555;">Tổng Số Lượng: </h2><p style="display: inline;">{{$total_qty}}</p>
                                                            </div>
                                                            <div class='contentEditable' style='text-align: left; color:#999999;font-size:13px;line-height:19px;'>
                                                                <h2 style="margin-left: 18px; font-size: 15px; display: inline; color: #555555;">Tổng Cộng: </h2><p style="display: inline;">@php echo number_format($total_sale,0).'đ'@endphp</p>
                                                            </div>
                                                        </div>
                                                    </td></tr>
                                            </table>
